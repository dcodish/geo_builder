...
// Slice 7/8 of the end-to-end scenario corpus (issue #60): membership is index % 8 === 6.
...
describe('reported scenarios — end-to-end replay of real bug reports (slice 7/8)', () => {
