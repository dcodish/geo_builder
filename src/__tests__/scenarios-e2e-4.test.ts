...
// Slice 4/8 of the end-to-end scenario corpus (issue #60): membership is index % 8 === 3.
...
describe('reported scenarios — end-to-end replay of real bug reports (slice 4/8)', () => {
