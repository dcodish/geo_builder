...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    guards:
      "Operator report 2026-07-19: the construct was missing — «מנקודה A יוצא משיק לשני המעגלים» was silently mis-parsed (an invented third circle with A as a mutual-tangency touch — the #215 P1), and even with «משותף» the rule had no apex concept (A was swept into the touch labels and placed ON circle O). The from-marker now binds the APEX role; the lowering reuses the ADR-239 two-touch bundle + a through-apex set-line per tangent (A strictly beyond both touches); a new A is a free point the two couplings pin at the tangents' crossing.",
