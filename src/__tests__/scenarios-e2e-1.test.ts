...
// Slice 1/8 of the end-to-end scenario corpus (issue #60): membership is index % 8 === 0.
...
describe('reported scenarios — end-to-end replay of real bug reports (slice 1/8)', () => {
