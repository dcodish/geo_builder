...
export const COMMAND_CATALOG: CommandDoc[] = [
  ...
  { category: 'circles', supported: true, en: 'AC extended meets circle P at E', he: 'המשך AC חותך את מעגל P בנקודה E', descEn: 'A line through two points, extended, crossing a circle at a new point (the crossing other than a shared end).', descHe: 'ישר דרך שתי נקודות, מוארך, החותך מעגל בנקודה חדשה (החיתוך שאינו הקצה המשותף).' },
