...
export const COMMAND_CATALOG: CommandDoc[] = [
  ...
  { category: 'constraints', supported: true, en: 'area of triangle ABC = 13', he: 'שטח המשולש ABC הוא 13', descEn: 'A polygon\'s area (also compact "SABC = 13"). A lone area sets the figure\'s scale; with another given it shapes it.', descHe: 'שטח של מצולע (גם בקיצור "SABC = 13"). שטח בודד קובע את גודל הסרטוט; עם נתון נוסף הוא קובע גם את הצורה.' },
  { category: 'constraints', supported: true, en: 'SABC/SDEF = 3/4', he: 'שטח ABF גדול פי 2 משטח BFE', descEn: 'A ratio between two polygon areas (also "area ABF = 2 area BFE", "a quarter of"). Reshapes the figure to satisfy it.', descHe: 'יחס בין שטחי שני מצולעים (גם "גדול פי 2 מ", "רבע מ"). משנה את הצורה כדי לקיימו.' },
  { category: 'constraints', supported: true, en: 'SABC = S', he: 'נסמן את שטח ABCD ב-S', descEn: 'Label a polygon\'s area with a letter; share it (e.g. SDEF = S) to relate two areas.', descHe: 'סימון שטח מצולע באות; שיתוף האות (למשל SDEF = S) קושר בין שני שטחים.' },
