...
_Drafted 2026-07-06 from the operator's dissatisfaction review: **"theorems that should appear don't appear, and it seems pretty random what theorems are presented."** This is the deep replan of the theorem-discovery feature on top of the Phase-6a spine ([16-theorems-plan.md](16-theorems-plan.md), ADR-208…224). Status: **ACCEPTED — decision-complete (2026-07-06). T1 BUILT ([ADR-235](06-decisions.md#adr-235), 2026-07-06): the coverage disposition map + totality guards, the measured fill order ([reports/theorem-fill-order.md](../reports/theorem-fill-order.md)), the full 22-question B-series corpus gate (membership assertions, `gaps` bucket documents today's misses), and the §9.5 feed-audit harness. T2 FIRST TRANCHE BUILT ([ADR-243](06-decisions.md#adr-243), 2026-07-06): the concyclic evidence enrichment (87/102 — 8 corpus questions flipped gaps→expect, incl. the B2c ≥4-members ruling), medians 15–17, congruence criteria 18–21 (the operator's '3 equal segments' example, with the shared-side no-reveal line), midsegments 62–67, bisectors 75/78/80; 66/109 now tabled (was 43 at T1). T2 COMPLETE ([ADR-244](06-decisions.md#adr-244) evidence worklist + [ADR-245](06-decisions.md#adr-245) full fill, 2026-07-07): **105/109 numbered ids tabled** (+201+appendix; 29/79/88/96 honest needs-construct, zero planned) — the R1 coverage cause is CLOSED. T3 BUILT ([ADR-246](06-decisions.md#adr-246), 2026-07-07): pointedness + subsumption (D6 fold-with-label) + the named band sort + rankTrace tooltips + the tested visibleFeed cap + §9.2 top-assertions — R3 is closed pending the operator's play-2-3-questions judgment. T4 BUILT ([ADR-247](06-decisions.md#adr-247), same day): MatchCtx.observed (relations + similar/congruent classes) → L3 amber paths for 69/20/28/22, the 💡 hint dress, the dial's +n affordance; scoped-out follow-ups recorded (emergent-midsegment + forced-parallel detectors don't exist yet). T5 BUILT ([ADR-248](06-decisions.md#adr-248), same day): principles.ts + the operator-editable catalog in 10-pedagogy (byte-guarded, D7) + 8 starters incl. the §6 archetypes + band-0 boosts (D5 amendment recorded). **THE REPLAN IS FULLY BUILT (T1–T5).** Remaining operator gates: the T3 play-and-judge pass, authoring ≥3 principles via the catalog path, and the 6c ship gate.** All §8 decision boxes were resolved by the operator one-by-one the same day (full catalog · converses as amber prompts · bands/no-percentages · default stays L1 · intent hints approved · subsumption folds with a label · principles catalog in 10-pedagogy). The §7a L2/L3 cutoff is accepted._
