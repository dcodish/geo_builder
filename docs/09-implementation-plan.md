...
>
> **Resume pointer.** **All three P1s of 2026-07-16 are FIXED:** #175 ([ADR-340](06-decisions.md#adr-340), validated composite views) + #173 ([ADR-341](06-decisions.md#adr-341), trapezoid long-base) DEPLOYED as `prod/2026-07-16-4`; **#177 ([ADR-342](06-decisions.md#adr-342) — anonymous auto-centres, the placing-vs-referencing binding rule) is MERGED to main (`a35b680`, suite 3613 green) awaiting deploy.** The P1 queue is EMPTY; next is the P2/P3 queue (#150-#172 range) + the standing operator gates (theorem-ranking play-and-judge, ≥3 principles, the 6c ship pass).
>
