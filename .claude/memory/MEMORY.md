...
- [Triage NEW-row cross-check](triage-new-rows-cross-check.md) — until #502 lands, /log-triage "NEW" rows must be checked against the issue tracker (per-machine state resurfaces already-filed rows after a PC switch)
