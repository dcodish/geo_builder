...
- [Vite binds IPv6 localhost](vite-binds-ipv6-localhost.md) — readiness polls must hit `localhost` not 127.0.0.1, and 5173–5180 are held by stale servers: use a high port and curl-check (round #992, 2026-09-11)
